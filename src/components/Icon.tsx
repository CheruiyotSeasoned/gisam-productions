...
/**
 * Inline SVG icon set (Lucide-style, MIT). Self-contained — no runtime fetch,
 * works in static export. Add new icons to the `paths` map as needed.
 */

export type IconName =
  | "mic" | "music" | "trophy" | "award" | "map-pin" | "calendar" | "ticket"
  | "check" | "check-circle" | "x-circle" | "play" | "handshake" | "lock"
  | "dashboard" | "users" | "credit-card" | "briefcase" | "file-text"
  | "settings" | "external-link" | "log-out" | "download" | "arrow-right"
  | "star" | "clock" | "chevron-right"
  // Big-Sam Production services (weddings, photo/video, audio, broadcast)
  | "camera" | "video" | "film" | "drone" | "radio" | "headphones"
  | "volume" | "heart" | "image" | "cast" | "megaphone" | "baby";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  drone: (<>
    ...
    <path d="m8 8-.7-.7M16 8l.7-.7M8 16l-.7.7M16 16l.7.7" />
  </>),
  radio: (<>
  ...
  cast: (<>
    ...
    <path d="M2 12a9 9 0 0 1 8 8M2 16a5 5 0 0 1 4 4" />
